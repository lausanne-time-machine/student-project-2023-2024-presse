  ...
  return (tokens, idx, options, context, self) => {
    ...
    try {
      ...
      if (source != null) {
        ...
        html2 += `<div id="cell-${id}" class="observablehq observablehq--block${node.expression ? " observablehq--loading" : ""}"></div>
`;
      }
    } catch (error) {
...
function getFooter(data, options) {
